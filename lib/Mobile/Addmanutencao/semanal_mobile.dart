...
class SemanalMobilePage extends StatefulWidget {
  const SemanalMobilePage({super.key});

  @override
  _SemanalMobilePageState createState() => _SemanalMobilePageState();
}

class _SemanalMobilePageState extends State<SemanalMobilePage> {
  ...
  Future<void> _saveChecklist() async {
    try {
      ...
      final checklistItems = [
        'Teste de partida manual e funcionamento por, no mínimo, 10 minutos.',
        'Verificação do nível de combustível.',
        'Inspeção dos filtros de ar e combustível quanto à presença de sujeira ou obstruções.',
        'Checagem do estado geral dos cabos e conexões elétricas.',
      ];
