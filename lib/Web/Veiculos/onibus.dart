...
class OnibusCheckPage extends StatefulWidget {
  const OnibusCheckPage({super.key});

  @override
  _OnibusCheckPageState createState() => _OnibusCheckPageState();
}

class _OnibusCheckPageState extends State<OnibusCheckPage> {
  ...
  Future<void> _saveChecklist() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Checklist Ônibus salvo com sucesso!')),
      );
    } catch (e) {
      // Tratamento de erros
      ScaffoldMessenger.of(context).showSnackBar(
