...
class CaminhaoCheckPage extends StatefulWidget {
  const CaminhaoCheckPage({super.key});

  @override
  _CaminhaoCheckPageState createState() => _CaminhaoCheckPageState();
}

class _CaminhaoCheckPageState extends State<CaminhaoCheckPage> {
  ...
  Future<void> _saveChecklist() async {
    try {
      ...
      final checklistItems = [
        ...
        'Conexões e cabos de freio e elétrica: Verificar condições e funcionamento.',
        'Sistema de engate(Reboque): Verificar condições e funcionamento.',
        'Sistema de suspensão: Verificar condições e funcionamento.',
        'Rodas da carreta: Verificar condições e funcionamento.',
        'Travamento das portas/traseira: Verificar condições e funcionamento.',
        'Carreta: Verificar integridade geral do reboque.',
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Checklist Caminhão salvo com sucesso!')),
      );
    } catch (e) {
      // Tratamento de erros
      ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Itens do Checklist de Caminhão:',
                          style: TextStyle(
