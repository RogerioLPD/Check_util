...
class VansCheckPage extends StatefulWidget {
  const VansCheckPage({super.key});

  @override
  _VansCheckPageState createState() => _VansCheckPageState();
}

class _VansCheckPageState extends State<VansCheckPage> {
  ...
  Future<void> _saveChecklist() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Checklist Van salvo com sucesso!')),
      );
    } catch (e) {
      // Tratamento de erros
      ScaffoldMessenger.of(context).showSnackBar(
