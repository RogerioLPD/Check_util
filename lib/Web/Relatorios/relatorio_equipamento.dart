...
class ListaEquipamentosScreen extends StatefulWidget {
  const ListaEquipamentosScreen({super.key});

  @override
  State<ListaEquipamentosScreen> createState() =>
      _ListaEquipamentosScreenState();
}

class _ListaEquipamentosScreenState extends State<ListaEquipamentosScreen> {
  Map<String, dynamic>? _equipamentoSelecionado;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      Provider.of<EquipamentoProvider>(context, listen: false)
          .listarEquipamentos(unidade);
    });
  }

  Future<void> _carregarChecklistFinalizado(
      String tag, DateTime dataInicio, DateTime dataFim) async {
      ...
      if (fim != null && fim.isAfter(inicio)) {
        ...
        if (_equipamentoSelecionado != null) {
          _carregarChecklistFinalizado(
              _equipamentoSelecionado!['tag'], inicio, fim);
        }
      } else {
        ...
        pw.Page(
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                pw.Text(
                  '${_equipamentoSelecionado!['tipoEquipamento']} - ${_equipamentoSelecionado!['tag']}',
                  style: pw.TextStyle(
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Consumer<EquipamentoProvider>( 
          builder: (context, equipamentoProvider, child) {
            final equipamentos = equipamentoProvider.equipamentos;
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<Map<String, dynamic>>(
                    ...
                    items: equipamentos.map((equip) {
                      return DropdownMenuItem<Map<String, dynamic>>(
                        value: equip,
                        child: Text(
                            '${equip['tipoEquipamento']} - ${equip['tag']}'),
                      );
                    }).toList(),
                    onChanged: (value) {
                      setState(() {
                        _equipamentoSelecionado = value;
                        _checklistFinalizado.clear();
                      });
                      if (_dataInicio != null && _dataFim != null) {
                        _carregarChecklistFinalizado(
                            value!['tag'], _dataInicio!, _dataFim!);
                      }
                    },
                  ),
